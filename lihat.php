...
<nav class="navbar navbar-expand-lg bg-light">
    ...
    <br>
        ...
        <br>
        <?php
            $sql    = "SELECT * FROM pesanan INNER JOIN lapangan ON lapangan.id_lap=pesanan.id_lap INNER JOIN waktu ON waktu.id_waktu=pesanan.id_waktu;";
        ...
        ?>
            ...
            <br>
            <a class="btn btn-dark" href="history.php" role="button">
            Kembali
            </a>
        </div>
    </center>
